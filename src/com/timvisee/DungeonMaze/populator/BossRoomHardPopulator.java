...
public class BossRoomHardPopulator extends BlockPopulator {
	...
	public void populate(World world, Random random, Chunk source) {
		...
		if(!DungeonMaze.isConstantChunk(world.getName(), source)) {
			...
			for (int y=30; y < 30+(4*6); y+=6) { /* Do three layers because the room is 3 heigh */
				if(distance(0, 0, source.getX(), source.getZ()) >= MIN_SPAWN_DISTANCE) {
					if (random.nextInt(1000) < CHANCE_OF_BOSSROOM) {
						...
						for (int x2=x; x2 < x + 15; x2+=1) {
						    for (int z2=z; z2 < z + 15; z2+=1) {
						        source.getBlock(x2, y, z2).setTypeId(49);
						    }
						}
						//glass shields
						...
						source.getBlock(x + 5, y + 1, z + 7).setTypeId(20);
						source.getBlock(x + 5, y + 1, z + 8).setTypeId(20);
						source.getBlock(x + 6, y + 1, z + 6).setTypeId(20);
						source.getBlock(x + 6, y + 1, z + 9).setTypeId(20);
						source.getBlock(x + 7, y + 1, z + 5).setTypeId(20);
						source.getBlock(x + 7, y + 1, z + 10).setTypeId(20);
						source.getBlock(x + 8, y + 1, z + 5).setTypeId(20);
						source.getBlock(x + 8, y + 1, z + 10).setTypeId(20);
						source.getBlock(x + 9, y + 1, z + 6).setTypeId(20);
						source.getBlock(x + 9, y + 1, z + 9).setTypeId(20);
						source.getBlock(x + 10, y + 1, z + 7).setTypeId(20);
						source.getBlock(x + 10, y + 1, z + 8).setTypeId(20);
						...
						source.getBlock(x + 5, y + 2, z + 7).setTypeId(20);
						source.getBlock(x + 5, y + 2, z + 8).setTypeId(20);
						source.getBlock(x + 6, y + 2, z + 6).setTypeId(20);
						source.getBlock(x + 6, y + 2, z + 9).setTypeId(20);
						source.getBlock(x + 7, y + 2, z + 5).setTypeId(20);
						source.getBlock(x + 7, y + 2, z + 10).setTypeId(20);
						source.getBlock(x + 8, y + 2, z + 5).setTypeId(20);
						source.getBlock(x + 8, y + 2, z + 10).setTypeId(20);
						source.getBlock(x + 9, y + 2, z + 6).setTypeId(20);
						source.getBlock(x + 9, y + 2, z + 9).setTypeId(20);
						source.getBlock(x + 10, y + 2, z + 7).setTypeId(20);
						source.getBlock(x + 10, y + 2, z + 8).setTypeId(20);
						source.getBlock(x + 12, y + 2, z + 3).setTypeId(20);
						source.getBlock(x + 12, y + 2, z + 12).setTypeId(20);
						source.getBlock(x + 6, y + 3, z + 7).setTypeId(20);
						source.getBlock(x + 6, y + 3, z + 8).setTypeId(20);
						source.getBlock(x + 7, y + 3, z + 6).setTypeId(20);
						source.getBlock(x + 7, y + 3, z + 9).setTypeId(20);
						source.getBlock(x + 8, y + 3, z + 6).setTypeId(20);
						source.getBlock(x + 8, y + 3, z + 9).setTypeId(20);
						source.getBlock(x + 9, y + 3, z + 7).setTypeId(20);
						source.getBlock(x + 9, y + 3, z + 8).setTypeId(20);
						source.getBlock(x + 7, y + 4, z + 7).setTypeId(20);
						source.getBlock(x + 7, y + 4, z + 8).setTypeId(20);
						source.getBlock(x + 8, y + 4, z + 7).setTypeId(20);
						source.getBlock(x + 8, y + 4, z + 8).setTypeId(20);
						// netherbrick hull
						source.getBlock(x + 6, y + 1, z + 7).setTypeId(112);
						source.getBlock(x + 6, y + 1, z + 8).setTypeId(112);
						source.getBlock(x + 7, y + 1, z + 6).setTypeId(112);
						source.getBlock(x + 7, y + 1, z + 9).setTypeId(112);
						source.getBlock(x + 8, y + 1, z + 6).setTypeId(112);
						source.getBlock(x + 8, y + 1, z + 9).setTypeId(112);
						source.getBlock(x + 9, y + 1, z + 7).setTypeId(112);
						source.getBlock(x + 9, y + 1, z + 8).setTypeId(112);
						source.getBlock(x + 6, y + 2, z + 7).setTypeId(112);
						source.getBlock(x + 6, y + 2, z + 8).setTypeId(112);
						source.getBlock(x + 7, y + 2, z + 6).setTypeId(112);
						source.getBlock(x + 7, y + 2, z + 9).setTypeId(112);
						source.getBlock(x + 8, y + 2, z + 6).setTypeId(112);
						source.getBlock(x + 8, y + 2, z + 9).setTypeId(112);
						source.getBlock(x + 9, y + 2, z + 7).setTypeId(112);
						source.getBlock(x + 9, y + 2, z + 8).setTypeId(112);
						source.getBlock(x + 7, y + 3, z + 7).setTypeId(112);
						source.getBlock(x + 7, y + 3, z + 8).setTypeId(112);
						source.getBlock(x + 8, y + 3, z + 7).setTypeId(112);
						source.getBlock(x + 8, y + 3, z + 8).setTypeId(112);
						//ores
						source.getBlock(x + 7, y + 1, z + 7).setTypeId(15);
						source.getBlock(x + 7, y + 1, z + 8).setTypeId(73);
						source.getBlock(x + 8, y + 1, z + 7).setTypeId(15);
						//chest

...
public class LavaOutOfWallPopulator extends BlockPopulator {
				...
				for (int x=0; x < 16; x+=8) {
					for (int z=0; z < 16; z+=8) {
						...
						if(!DungeonMaze.isConstantRoom(world.getName(), source, x, y, z)) {
							if (random.nextInt(100) < CHANCE_OF_LAVA+(CHANCE_OF_LAVA_ADDITION_PER_LEVEL*(y-30)/6)) {

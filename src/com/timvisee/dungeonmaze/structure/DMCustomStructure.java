...
public class DMCustomStructure {
	 ...
	 */
	public DMCustomStructure(String name, int chance) {
		this.name = name;
		this.chance = chance;
	}
	 ...
	 */
	public DMCustomStructure(String name, int chance, int minLayer, int maxLayer) {
		this.name = name;
		this.chance = chance;

...
public class BossRoomHardPopulator extends DMMazeLayerBlockPopulator {
	...
	public void populateLayer(DMMazeLayerBlockPopulatorArgs args) {
		...
		if(rand.nextInt(1000) < CHANCE_OF_BOSSROOM) {
			...
			for(int x2=x; x2 < x + 15; x2+=1)
			    for(int z2=z; z2 < z + 15; z2+=1)
			        c.getBlock(x2, y, z2).setTypeId(49);
			...
			c.getBlock(x + 5, y + 1, z + 7).setTypeId(20);
			c.getBlock(x + 5, y + 1, z + 8).setTypeId(20);
			c.getBlock(x + 6, y + 1, z + 6).setTypeId(20);
			c.getBlock(x + 6, y + 1, z + 9).setTypeId(20);
			c.getBlock(x + 7, y + 1, z + 5).setTypeId(20);
			c.getBlock(x + 7, y + 1, z + 10).setTypeId(20);
			c.getBlock(x + 8, y + 1, z + 5).setTypeId(20);
			c.getBlock(x + 8, y + 1, z + 10).setTypeId(20);
			c.getBlock(x + 9, y + 1, z + 6).setTypeId(20);
			c.getBlock(x + 9, y + 1, z + 9).setTypeId(20);
			c.getBlock(x + 10, y + 1, z + 7).setTypeId(20);
			c.getBlock(x + 10, y + 1, z + 8).setTypeId(20);
			...
			c.getBlock(x + 5, y + 2, z + 7).setTypeId(20);
			c.getBlock(x + 5, y + 2, z + 8).setTypeId(20);
			c.getBlock(x + 6, y + 2, z + 6).setTypeId(20);
			c.getBlock(x + 6, y + 2, z + 9).setTypeId(20);
			c.getBlock(x + 7, y + 2, z + 5).setTypeId(20);
			c.getBlock(x + 7, y + 2, z + 10).setTypeId(20);
			c.getBlock(x + 8, y + 2, z + 5).setTypeId(20);
			c.getBlock(x + 8, y + 2, z + 10).setTypeId(20);
			c.getBlock(x + 9, y + 2, z + 6).setTypeId(20);
			c.getBlock(x + 9, y + 2, z + 9).setTypeId(20);
			c.getBlock(x + 10, y + 2, z + 7).setTypeId(20);
			c.getBlock(x + 10, y + 2, z + 8).setTypeId(20);
			c.getBlock(x + 12, y + 2, z + 3).setTypeId(20);
			c.getBlock(x + 12, y + 2, z + 12).setTypeId(20);
			c.getBlock(x + 6, y + 3, z + 7).setTypeId(20);
			c.getBlock(x + 6, y + 3, z + 8).setTypeId(20);
			c.getBlock(x + 7, y + 3, z + 6).setTypeId(20);
			c.getBlock(x + 7, y + 3, z + 9).setTypeId(20);
			c.getBlock(x + 8, y + 3, z + 6).setTypeId(20);
			c.getBlock(x + 8, y + 3, z + 9).setTypeId(20);
			c.getBlock(x + 9, y + 3, z + 7).setTypeId(20);
			c.getBlock(x + 9, y + 3, z + 8).setTypeId(20);
			c.getBlock(x + 7, y + 4, z + 7).setTypeId(20);
			c.getBlock(x + 7, y + 4, z + 8).setTypeId(20);
			c.getBlock(x + 8, y + 4, z + 7).setTypeId(20);
			c.getBlock(x + 8, y + 4, z + 8).setTypeId(20);
			
			// Netherbrick hull
			c.getBlock(x + 6, y + 1, z + 7).setTypeId(112);
			c.getBlock(x + 6, y + 1, z + 8).setTypeId(112);
			c.getBlock(x + 7, y + 1, z + 6).setTypeId(112);
			c.getBlock(x + 7, y + 1, z + 9).setTypeId(112);
			c.getBlock(x + 8, y + 1, z + 6).setTypeId(112);
			c.getBlock(x + 8, y + 1, z + 9).setTypeId(112);
			c.getBlock(x + 9, y + 1, z + 7).setTypeId(112);
			c.getBlock(x + 9, y + 1, z + 8).setTypeId(112);
			c.getBlock(x + 6, y + 2, z + 7).setTypeId(112);
			c.getBlock(x + 6, y + 2, z + 8).setTypeId(112);
			c.getBlock(x + 7, y + 2, z + 6).setTypeId(112);
			c.getBlock(x + 7, y + 2, z + 9).setTypeId(112);
			c.getBlock(x + 8, y + 2, z + 6).setTypeId(112);
			c.getBlock(x + 8, y + 2, z + 9).setTypeId(112);
			c.getBlock(x + 9, y + 2, z + 7).setTypeId(112);
			c.getBlock(x + 9, y + 2, z + 8).setTypeId(112);
			c.getBlock(x + 7, y + 3, z + 7).setTypeId(112);
			c.getBlock(x + 7, y + 3, z + 8).setTypeId(112);
			c.getBlock(x + 8, y + 3, z + 7).setTypeId(112);
			c.getBlock(x + 8, y + 3, z + 8).setTypeId(112);
			
			// Ores
			c.getBlock(x + 7, y + 1, z + 7).setTypeId(15);
			c.getBlock(x + 7, y + 1, z + 8).setTypeId(73);
			c.getBlock(x + 8, y + 1, z + 7).setTypeId(15);
			
			// Chest
			c.getBlock(x + 8, y + 1, z + 8).setTypeId(54);

...
public class EventListenerManager {
    ...
    private DMBlockListener blockListener;
    /** Player listener instance. */
    private DMPlayerListener playerListener;
    /** Plugin listener instance. */
    private DMPluginListener pluginListener;
    /** World listener instance. */
    private DMWorldListener worldListener;
    ...
    public boolean init(boolean registerListeners) {
        ...
        this.blockListener = new DMBlockListener();
        this.playerListener = new DMPlayerListener();
        this.pluginListener = new DMPluginListener();
        this.worldListener = new DMWorldListener();
     ...
     */
    public DMBlockListener getBlockListener() {
     ...
     */
    public DMPlayerListener getPlayerListener() {
     ...
     */
    public DMPluginListener getPluginListener() {
     ...
     */
    public DMWorldListener getWorldListener() {

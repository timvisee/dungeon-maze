...
public class GenerationChestEvent extends EventHandler {
	
	private Block b;
	private Random rand;
	private List<ItemStack> is;
	private boolean addContentsInOrder = false;
	private MazeStructureType structureType = MazeStructureType.UNSTRUCTURE;
	private String structureName = "CUSTOM";
	
	public GenerationChestEvent(Block b, Random rand, List<ItemStack> is, MazeStructureType structureType) {
		this.b = b;
		this.is = is;
		this.rand = rand;
	 ...
	 */
	public MazeStructureType getStructureType() {
